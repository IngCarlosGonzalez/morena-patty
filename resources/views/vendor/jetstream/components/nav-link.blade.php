...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-gray-700 text-lg font-sans leading-5 text-gray-900 focus:outline-none focus:border-gray-800 transition'
