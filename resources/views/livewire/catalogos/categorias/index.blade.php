...
>
    ...
    {{-- Componente: listado de INDEX de las CATEGORÍAS de CONTACTOS --}}
    {{-- °°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°° --}}
                ...
                <table class="border-collapse table-fixed">
                    ...
                    <thead class="h-12 text-white bg-gray-800 border-t-4 border-l-2 border-r-2 border-gray-500">
                        ...
                        <tr class="text-left uppercase">
                            ...
                            <th wire:click="clasifica('clasificacion')" class="w-6/12 pl-4 cursor-pointer">
                                Descripción
                    ...
                    <tbody class="text-white">
                        ...
                        @foreach ($acuales as $catego)

                        <tr class="border-2 border-gray-500">

                            <td class="px-4 py-2">&nbsp;</td>

                            <td class="px-4 py-2">&nbsp;{{ $catego->id }}</td>

                            <td class="px-4 py-2">&nbsp;</td>

                            <td class="px-4 py-2 w-auto">{{ $catego->clasificacion }}</td>
                            ...
                            <td class="px-4 py-2">
                                <div class="flex flex-row">
                                    ...
                                    <button
                                            ...
                                            wire:click="$emit('confirmarDelete', {{ $catego->id }})"
                                    >
                                        BORRAR
                                    </button>
                    ...
                    >
                        <div class="mx-24 mt-4">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center ">
                                {{-- Aquí entra la descripcion de la clasificacion --}}
                                <label for="clasificacion" class="w-48 mt-2 mb-8 text-base font-normal leading-none text-gray-300 ">
                                    Descripción:
                                </label>
                                <input
                                    ...
                                    wire:model.defer="clasificacion"
                                >
                            </div>
    ...
    <x-jet-dialog-modal wire:model="abrir">
        ...
        <x-slot name="title">
            <div class="text-center">
                Editando Categoría <span class="ml-4"> {{ $editando->clasificacion }} </span>
            </div>
        </x-slot>
                ...
                <div class="my-32">
                    ...
                    >
                        <div class="mx-24 mt-1">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center ">
                                {{-- Aquí entra el contenido de la clasificacion --}}
                                <label for="clasificacion" class="w-48 mt-2 mb-8 text-base font-normal leading-none text-gray-300 ">
                                    De:
                                </label>
                                <input
    ...
    <script>
        ...
        Livewire.on('procesaOk', () => {
            ...
            swalWithBootstrapButtons.fire({
                title: 'Procesado!',
                text: 'El Registro fué Agregado Correctamente.',
                icon: 'success',
                width: 600,
                padding: '3em',
                color: '#000000',
    ...
    <script>
        ...
        Livewire.on('confirmarDelete', (catego) => {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.value) {
                    Livewire.emitTo('catalogos.categorias.index', 'delete', catego )
                } else {
